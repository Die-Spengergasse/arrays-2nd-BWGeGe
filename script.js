...
function split() {
    const i1 = eval(input1.value);
    const i2 = eval(input2.value);
    output.publish(i1.split(i2));
}

function join() {
    const i1 = eval(input1.value);
    const i2 = eval(input2.value);
    output.publish(i1.join(i2));
}

function some() {
    const i1 = eval(input1.value);
    const i2 = eval(input2.value);
    output.publish(i1.some((x) => x == i2));
}

function reverse() {
    const i1 = eval(input1.value);
    output.publish(i1.reverse());
}

function spread() {
    const i1 = eval(input1.value);
    const i2 = eval(input2.value);
    output.publish(...i1,...i2);
}
